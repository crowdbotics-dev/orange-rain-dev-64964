"""
Django settings for orange_rain_dev_64964 project.
...
ROOT_URLCONF = 'orange_rain_dev_64964.urls'
...
WSGI_APPLICATION = 'orange_rain_dev_64964.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_rain_dev_64964 API",
    "DESCRIPTION": "API documentation for orange_rain_dev_64964 App",
    "VERSION": "v1",
}
